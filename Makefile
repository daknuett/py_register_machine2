...
html: 
	...
	cp -r $(BUILDDIR)/html/_static/* ./static/
	cp -r $(BUILDDIR)/html/_images/* ./images/
...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/py_register_machine2.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/py_register_machine2.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/py_register_machine2"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/py_register_machine2"
	@echo "# devhelp"
